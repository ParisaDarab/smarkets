...
import { common } from '@/lib/i18n/en';
...
export function AppHeader() {
  ...
  return (
    <header className="border-b border-border bg-white">
      <div className="mx-auto flex max-w-[80%] items-center justify-between px-4 py-3">
        <Link
          to="/"
        ...
        <Button
          ...
          className={
            ' hover:border-red-600 hover:bg-red-50 transition duration-300  hover:scale-105 w-fit h-8 text-center'
          }
        >
